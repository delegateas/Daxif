...
[<assembly: AssemblyVersionAttribute("4.5.6")>]
[<assembly: AssemblyFileVersionAttribute("4.5.6")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.5.6"
    let [<Literal>] AssemblyFileVersion = "4.5.6"
