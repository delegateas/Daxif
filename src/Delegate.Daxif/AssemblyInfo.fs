...
[<assembly: AssemblyVersionAttribute("4.2.11")>]
[<assembly: AssemblyFileVersionAttribute("4.2.11")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.2.11"
    let [<Literal>] AssemblyFileVersion = "4.2.11"
