...
[<assembly: AssemblyVersionAttribute("4.7.1")>]
[<assembly: AssemblyFileVersionAttribute("4.7.1")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.7.1"
    let [<Literal>] AssemblyFileVersion = "4.7.1"
