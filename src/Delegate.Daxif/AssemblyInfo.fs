...
[<assembly: AssemblyVersionAttribute("4.2.9")>]
[<assembly: AssemblyFileVersionAttribute("4.2.9")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.2.9"
    let [<Literal>] AssemblyFileVersion = "4.2.9"
