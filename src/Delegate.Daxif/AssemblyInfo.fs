...
[<assembly: AssemblyVersionAttribute("4.2.12")>]
[<assembly: AssemblyFileVersionAttribute("4.2.12")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.2.12"
    let [<Literal>] AssemblyFileVersion = "4.2.12"
