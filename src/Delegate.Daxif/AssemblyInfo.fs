...
[<assembly: AssemblyVersionAttribute("4.2.10")>]
[<assembly: AssemblyFileVersionAttribute("4.2.10")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.2.10"
    let [<Literal>] AssemblyFileVersion = "4.2.10"
